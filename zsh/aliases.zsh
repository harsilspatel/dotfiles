...
# frequent files
alias va="$EDITOR \"$DOTFILES/zsh/aliases.zsh\""
alias vd="code $DOTFILES"
alias vh="code $DOTFILES/hammerspoon"
alias vc="crontab -e"
alias ve="$EDITOR \"$DOTFILES/zsh/env.zsh\""
alias vf="$EDITOR \"$DOTFILES/zsh/functions.zsh\""
